...
class Model:
    ...
    def __init__(self, params, vocab_size, num_chars, W_init, embed_dim, num_out, 
        ...
        cand_var, doccoref_var, qrycoref_var = T.itensor3('cand'), T.btensor3('coref'), \
                T.btensor3('qcoref')
        ...
        self.predicted_probs, predicted_probs_val, \
                ...
                self.build_network(K, vocab_size, W_pert, cloze, num_out))
    ...
    def train(self, dw, dt, qw, qt, c, a, m_dw, m_qw, tt, tm, m_c, cl, crd, crq):
        ...
        return self.train_fn(dw, dt, qw, qt, c, a, 
                ...
                tt, tm.astype('int8'), 
                m_c.astype('int8'), f, cl, crdi, crqi, self.learning_rate)
    ...
    def build_network(self, K, vocab_size, W_init, cloze, num_out):
        ...
        l_prob = SelectionLayer([l_doc_1, l_ans], 2*self.nhidden, num_out,
                mask_input=self.inps[6])
