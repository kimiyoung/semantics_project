...
class Model:
    ...
    def __init__(self, K, vocab_size, num_chars, W_init, regularizer, rlambda, 
            ...
            gating_fn, coref, save_attn=False):
        ...
        self.coref = coref
        self.max_coref_chains = MAX_COREF_CHAINS
    ...
    def train(self, dw, dt, qw, qt, c, a, m_dw, m_qw, tt, tm, m_c, cl, cr, a_cr, ci):
        ...
        return self.train_fn(dw, dt, qw, qt, c, a, 
                ...
                tt, tm.astype('int8'), 
                m_c.astype('int8'), f, cl, cr, a_cr, ci)

    def validate(self, dw, dt, qw, qt, c, a, m_dw, m_qw, tt, tm, m_c, cl, cr, a_cr, ci):
        f = prepare_input(dw,qw)
        if self.subsample!=-1: m_dw = sub_sample(m_dw, m_c, self.subsample)
    ...
    def build_network(self, K, vocab_size, W_init):
        ...
        l_corefin = L.InputLayer(shape=(None,None,self.max_coref_chains), 
